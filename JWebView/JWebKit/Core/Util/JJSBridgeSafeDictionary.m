...
@interface JJSBridgeSafeDictionary()
...
@implementation JJSBridgeSafeDictionary

- (instancetype)initCommon {
    self = [super init];
    if (self) {
        _readWriteQuene = dispatch_queue_create([@"com.JJSBridgeSafeDictionary.readWriteQuene" UTF8String], DISPATCH_QUEUE_CONCURRENT);
    }
    return self;
}
